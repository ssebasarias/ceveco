...
class AsesorModal {
            ...
            <div id="asesorModal" class="asesor-modal" style="display: none;" role="dialog" aria-modal="true" aria-labelledby="asesorModalTitle">
                ...
                <div class="asesor-modal-content">
                    ...
                    <div class="asesor-modal-header">
                        <h2 id="asesorModalTitle">¿Con quién quieres cotizar?</h2>
                        <p class="asesor-modal-subtitle">Elige la sede o la línea de motos que prefieras, o déjanos asignar una disponible.</p>
                    </div>
                    ...
                    <div class="asesor-modal-footer">
                        <button class="asesor-random-link" type="button">
                            ...
                            Asignarme una línea disponible
                        </button>
                    </div>
                </div>
            </div>
    ...
    renderAsesores() {
        ...
        if (!this.asesores.length) {
            grid.innerHTML = `
                <div class="asesor-empty">
                    No hay líneas de contacto disponibles en este momento. Intenta más tarde.
                </div>
            `;
            return;
        }
        ...
        grid.innerHTML = this.asesores.map(a => {
            ...
            // Solo mostramos estrellas si realmente hay calificaciones; si no, la
            // tarjeta queda sin rating en vez de inventar un 0.0 o un 5.0.
            const totalCalif = Number(a.total_calificaciones) || 0;
            const rating = totalCalif > 0 ? (Number(a.calificacion_promedio) || 0) : null;
                ...
                <button type="button" class="asesor-card"
                    ...
                    <span class="asesor-card-info">
                        ...
                        <span class="asesor-card-rating">
                            ...
                            <span class="asesor-card-rating-num">${rating.toFixed(1)}</span>
                        </span>` : ''}
                    </span>
    ...
    // El destinatario ya es la sede/línea elegida, así que el saludo va sin nombre.
