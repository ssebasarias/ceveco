// Tailwind CSS theme config — only used when Tailwind CDN runtime is loaded.
// The compiled Tailwind build uses frontend/tailwind.config.js instead.
// Guarded so this file is a no-op when CDN is absent.
